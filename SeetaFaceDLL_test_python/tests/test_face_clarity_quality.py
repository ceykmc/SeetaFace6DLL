...
from SeetaFace6 import FaceClarityQuality, FaceDetector, LandmarkDetector


def main():
    face_detector = FaceDetector()
    landmark_detector = LandmarkDetector()
    clarity_quality = FaceClarityQuality()

    image_path = "./data/133-1672-0-84-90_0_.png"
    ...
    level, score = clarity_quality.check_clarity_quality(
        image, faces[0][:4], points)
    print(F"level is: {level}, score is: {score}")
